...
| Secret + image audit logic | 46/46 pass | `python3 tests/test_image_audit.py` | every edit |
| DeckState JS helpers | 37/37 pass | `node tests/test_deckstate.js` | every edit |
