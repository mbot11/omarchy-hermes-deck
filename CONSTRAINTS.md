...
| Collector behaviour | 31/31 pass | `python3 tests/test_collect.py` | every edit |
| Action dispatcher | 26/26 pass | `python3 tests/test_act.py` | every edit |
| Image audit logic | 13/13 pass | `python3 tests/test_image_audit.py` | every edit |
| DeckState JS helpers | 13/13 pass | `node tests/test_deckstate.js` | every edit |
