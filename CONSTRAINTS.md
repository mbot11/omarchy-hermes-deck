...
| Collector behaviour | 33/33 pass | `python3 tests/test_collect.py` | every edit |
| Action dispatcher | 25/25 pass | `python3 tests/test_act.py` | every edit |
| Image audit logic | 16/16 pass | `python3 tests/test_image_audit.py` | every edit |
| DeckState JS helpers | 17/17 pass | `node tests/test_deckstate.js` | every edit |
